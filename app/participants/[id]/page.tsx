...
// Function to get appropriate icon for project category
const getProjectCategoryIcon = (category: string) => {
  const iconMap: Record<string, React.ComponentType<{ className?: string }>> = {
    ...
    "Community": Users,
    "Cognitive Rehabilitation": Brain,
  ...
  return iconMap[category] || BookOpen // Default to BookOpen if category not found
}
    ...
    return (
      <div className="flex h-screen">
        ...
        <div className="flex-1 p-6 flex items-center justify-center">
          <p className="text-black">Participant not found</p>
        </div>
      </div>
    )
  }
      ...
      <div className="flex-1 overflow-auto">
        <div className="p-6">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-black">{participant.name}</h1>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Profile Image */}
            <div className="md:col-span-1 flex justify-center">
              <div className="w-64 h-64 rounded-full overflow-hidden bg-gray-50">
                <Image
            ...
            <div className="md:col-span-2">
              <div className="glass-card rounded-xl p-6 mb-6">
                <div className="flex justify-between items-start mb-4">
                  <h2 className="text-xl font-semibold text-black">General Information</h2>
                  <button className="text-gray-600 hover:text-black transition-colors">
                    <Pencil className="w-5 h-5" />
                  </button>
                </div>
                <p className="text-gray-600 leading-relaxed">{participant.generalInfo}</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="glass-card rounded-xl p-4">
                  <div className="flex justify-between items-center">
                    <div>
                      <p className="text-xs text-gray-600">Assistive Technology</p>
                      <p className="text-black font-medium">{participant.assistiveTechnology}</p>
                    </div>
                ...
                <div className="glass-card rounded-xl p-4">
                  <div className="flex justify-between items-center">
                    <div>
                      <p className="text-xs text-gray-600">Work History</p>
                      <p className="text-black font-medium">{participant.workHistory}</p>
                    </div>
                    <ChevronRight className="w-5 h-5 text-gray-600" />
                  </div>
                </div>
                ...
                <div className="glass-card rounded-xl p-4">
                  <div className="flex justify-between items-center">
                    <div>
                      <p className="text-xs text-gray-600">Hometown</p>
                      <p className="text-black font-medium">{participant.hometown}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="glass-card rounded-xl p-4">
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-black font-medium">{participant.birthday}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {participant.skills.map((skill, index) => (
                <div key={index} className="flex flex-col">
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="text-sm font-medium text-black">{skill.value}%</span>
                  </div>
                  ...
                  <div className="bg-gray-50 p-4">
                    <div className="flex justify-between items-center">
                      <div className="flex-1">
                        <h3 className="text-black font-medium">{goal.name}</h3>
                        <div className="flex items-center mt-1">
                          <div className="flex-1 h-2 bg-gray-50 rounded-full mr-3">
                            <div className="h-2 rounded-full bg-[#63b7e6]" style={{ width: `${goal.progress}%` }}></div>
                          </div>
                          <span className="text-sm text-gray-600 w-12 text-right">{goal.progress}%</span>
                        </div>
                      </div>
                      <button
                        onClick={() => toggleGoalExpansion(goal.id)}
                        className="ml-4 p-2 rounded-full hover:bg-gray-50 transition-colors"
                      >
                  ...
                  {expandedGoals[goal.id] && (
                    <div className="p-4 space-y-3">
                      {goal.subgoals.map((subgoal) => (
                        <div key={subgoal.id} className="flex items-start p-3 bg-gray-50 rounded-lg">
                          <div className="flex-shrink-0 mr-3 mt-0.5">
                            <button
                              onClick={() => toggleSubgoalCompletion(goal.id, subgoal.id)}
                              className={`w-5 h-5 rounded flex items-center justify-center border ${
                                subgoal.isCompleted ? "bg-[#63b7e6] border-[#63b7e6]" : "bg-gray-50 border-white/40"
                              }`}
                            >
                              {subgoal.isCompleted && <Check className="w-3 h-3 text-black" />}
                            </button>
                          </div>
                          <div className="flex-1">
                            <div className="flex items-center">
                              <h4
                                className={`text-sm font-medium ${
                                  subgoal.isCompleted ? "text-gray-600 line-through" : "text-black"
                                }`}
                              >
                                {subgoal.name}
                              </h4>
                              {subgoal.isCompleted && subgoal.dateCompleted && (
                                <span className="ml-2 text-xs text-gray-600">Completed: {subgoal.dateCompleted}</span>
                              )}
                            </div>
                            {subgoal.notes && (
                              <p className="text-xs text-gray-600 mt-1 bg-gray-50 p-2 rounded">{subgoal.notes}</p>
                            )}
                          </div>
                        </div>
                      ))}
                      <div className="flex justify-end mt-2">
                        <button className="text-black/80 text-sm hover:text-black transition-colors flex items-center">
          ...
          <div className="mt-6 glass-card rounded-xl p-6">
            <div className="flex justify-between items-start mb-6">
              <h2 className="text-xl font-semibold text-black">Things to Keep in Mind</h2>
              <button className="text-gray-600 hover:text-black transition-colors">
                <Pencil className="w-5 h-5" />
              </button>
            </div>
          ...
          <div className="mt-6 glass-card rounded-xl p-6">
            <div className="flex justify-between items-start mb-6">
              <h2 className="text-xl font-semibold text-black">Fact Sheet</h2>
              <button className="text-gray-600 hover:text-black transition-colors">
                <Pencil className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="mb-4">
              <h3 className="font-medium text-black mb-2">Staff Notes:</h3>
              <p className="text-gray-600">{participant.factSheet.staffNotes}</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-sm text-gray-600 mb-1">Hobbies</p>
                <p className="text-black">{participant.factSheet.hobbies}</p>
              </div>

              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-sm text-gray-600 mb-1">Favorite Color</p>
                <p className="text-black">{participant.factSheet.favoriteColor}</p>
              </div>

              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-sm text-gray-600 mb-1">Favorite Food</p>
                <p className="text-black">{participant.factSheet.favoriteFood}</p>
              </div>

              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-sm text-gray-600 mb-1">Favorite Artist/Musician</p>
                <p className="text-black">{participant.factSheet.favoriteArtist}</p>
              </div>

              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-sm text-gray-600 mb-1">Pets</p>
                <p className="text-black">{participant.factSheet.pets}</p>
              </div>

              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-sm text-gray-600 mb-1">Dislikes</p>
                <p className="text-black">{participant.factSheet.dislikes}</p>
              </div>

              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-sm text-gray-600 mb-1">Favorite Sports Team</p>
                <p className="text-black">{participant.factSheet.favoriteSportsTeam}</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 glass-card rounded-xl p-6">
            <div className="flex justify-between items-start mb-6">
              <h2 className="text-xl font-semibold text-black">Past Projects</h2>
              <button className="text-gray-600 hover:text-black transition-colors">
            ...
            <div className="space-y-6">
              {participant.projects.map((project) => {
                const IconComponent = getProjectCategoryIcon(project.category)
                return (
                  <div
                    key={project.id}
                    className="flex items-start border-b border-gray-200 pb-6 last:border-0 last:pb-0"
                  >
                    <div className="w-20 h-20 rounded-lg bg-gray-50 flex-shrink-0 mr-4 flex items-center justify-center">
                      ...
                      <div className="flex justify-between">
                        <div>
                          ...
                          <div className="flex items-center text-sm text-gray-600">
                            ...
                            <span className="text-black/80 hover:text-black cursor-pointer transition-colors">• See project details</span>
                          </div>
                        </div>
                        <button className="text-gray-600 hover:text-black transition-colors">
