        ...
        <div className="p-6">
          ...
          <div className="mb-10">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-black">Today's Attendees</h2>
            ...
            <div className="relative">
              ...
              >
                {todaysAttendees.map((participant) => (
                  ...
                  >
                    <button
                      ...
                      className="absolute top-4 right-4 bg-red-50 p-1.5 rounded-full text-red-400 hover:bg-red-100 hover:text-red-600 transition-colors"
                    ...
                    <h3 className="text-lg font-semibold text-black mb-1">{participant.name}</h3>
                    <p className="text-sm text-gray-600 mb-1">{participant.joinedDate}</p>
                    <p className="text-sm text-gray-600 mb-4">{participant.birthdate}</p>
                    ...
                    <Link href={`/participants/${participant.id}`}>
                      <button className="bg-[#87CEEB] text-white px-4 py-2 rounded-xl hover:bg-[#6BB6E0] hover-scale transition-smooth">
                        View Profile
                      </button>
                    </Link>
                  </div>
                ...
                {todaysAttendees.length === 0 && (
                  <div className="flex-shrink-0 w-full bg-white rounded-xl p-6 flex flex-col items-center justify-center h-[350px] shadow-sm">
