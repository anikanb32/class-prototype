            ...
            <div className="glass-card rounded-xl p-4 mb-8">
              <div className="flex justify-between items-center mb-4">
                ...
                <Link href="/participants">
                  <button className="text-[#87CEEB] text-sm font-medium hover:text-[#6BB6E0] transition-colors">Manage Attendance</button>
                </Link>
              </div>
              <div className="flex flex-wrap gap-3">
                {presentParticipants.map((participant) => (
                  <div key={participant.id} className="flex items-center bg-blue-50 rounded-full px-3 py-1 shadow-md">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
            ...
            <div className="glass-card rounded-xl p-6">
              ...
              <div className="flex justify-between items-center mb-6">
                <div>
                  <h2 className="text-xl font-bold text-black">Suggested Activity Categories</h2>
                  {presentParticipants.length > 0 ? (
                    ...
                    <p className="text-xs text-gray-600 mt-1">Match scores based on all participant profiles</p>
                  )}
                </div>
                <div className="flex items-center">
                  <button className="text-gray-500 hover:text-gray-700 p-1 rounded-full transition-colors">
                  ...
                  <div key={category.id} className="rounded-xl border border-gray-200 overflow-hidden">
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <div>
                          <div className="flex items-center">
                            <h3 className="text-black font-medium mr-2">{category.name}</h3>
                            <div className="flex items-center bg-[#63B7E6] bg-opacity-20 text-[#63B7E6] text-xs font-medium px-2 py-1 rounded-full">
            ...
            <div>
              <div className="flex justify-between items-center mb-6">
                ...
                <button className="text-[#6BB6E0] text-sm font-medium hover:text-[#4A9FD1] transition-colors">See all</button>
              </div>
                ...
                {recentActivities.map((activity) => (
                  ...
                  >
                    <div className="flex items-center flex-1 min-w-0">
                      <div
                        className={`w-12 h-12 flex-shrink-0 rounded-xl ${getIconBgColor(
                          activity.category,
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center flex-wrap">
                            <h3 className="text-black font-medium mr-2">{activity.title}</h3>
                            {activity.daysAgo && <span className="text-xs text-gray-500">{activity.daysAgo}</span>}
                            <div
                        ...
                        <button
                          className={`w-full text-left px-3 py-2 rounded-md flex items-center justify-between ${
                            sortBy === "title" && sortOrder === "asc"
                              ? "bg-[#87CEEB] bg-opacity-10 text-[#87CEEB]"
                  ...
                  {categoryDropdownOpen && (
                    <div className="absolute right-0 mt-2 w-56 glass-card rounded-md shadow-lg z-10 border border-gray-200 max-h-96 overflow-y-auto" style={{ borderRadius: '6px' }}>
                      <div className="p-2">
                        <button
                          className={`w-full text-left px-3 py-2 rounded-md flex items-center justify-between ${
                            activeFilter === null ? "bg-[#87CEEB] bg-opacity-10 text-[#87CEEB]" : "hover:bg-gray-50 text-gray-700"
                          }`}
                        ...
                        <div className="mt-1 mb-1 px-3 text-xs font-semibold text-gray-600">Rehabilitation Skills</div>
                        <button
                          className={`w-full text-left px-3 py-2 rounded-md flex items-center justify-between ${
                            activeFilter === "Memory" ? "bg-[#87CEEB] bg-opacity-10 text-[#87CEEB]" : "hover:bg-gray-50 text-gray-700"
                          }`}
                        ...
                        <button
                          className={`w-full text-left px-3 py-2 rounded-md flex items-center justify-between ${
                            activeFilter === "Cognitive" ? "bg-[#87CEEB] bg-opacity-10 text-[#87CEEB]" : "hover:bg-gray-50 text-gray-700"
                          }`}
                        ...
                        <button
                          className={`w-full text-left px-3 py-2 rounded-md flex items-center justify-between ${
                            activeFilter === "Executive" ? "bg-[#87CEEB] bg-opacity-10 text-[#87CEEB]" : "hover:bg-gray-50 text-gray-700"
                          }`}
                        ...
                        <button
                          className={`w-full text-left px-3 py-2 rounded-md flex items-center justify-between ${
                            activeFilter === "Attention" ? "bg-[#87CEEB] bg-opacity-10 text-[#87CEEB]" : "hover:bg-gray-50 text-gray-700"
                          }`}
                        ...
                        <button
                          className={`w-full text-left px-3 py-2 rounded-md flex items-center justify-between ${
                            activeFilter === "Language" ? "bg-[#87CEEB] bg-opacity-10 text-[#87CEEB]" : "hover:bg-gray-50 text-gray-700"
                          }`}
                        ...
                        <button
                          className={`w-full text-left px-3 py-2 rounded-md flex items-center justify-between ${
                            activeFilter === "Motor" ? "bg-[#87CEEB] bg-opacity-10 text-[#87CEEB]" : "hover:bg-gray-50 text-gray-700"
                          }`}
                        ...
                        <button
                          className={`w-full text-left px-3 py-2 rounded-md flex items-center justify-between ${
                            activeFilter === "Problem" ? "bg-[#87CEEB] bg-opacity-10 text-[#87CEEB]" : "hover:bg-gray-50 text-gray-700"
                          }`}
                        ...
                        <button
                          className={`w-full text-left px-3 py-2 rounded-md flex items-center justify-between ${
                            activeFilter === "Emotional" ? "bg-[#87CEEB] bg-opacity-10 text-[#87CEEB]" : "hover:bg-gray-50 text-gray-700"
                          }`}
                        ...
                        {/* Other Categories */}
                        <div className="mt-1 mb-1 px-3 text-xs font-semibold text-gray-600">Other Skills</div>
                        <button
                          className={`w-full text-left px-3 py-2 rounded-md flex items-center justify-between ${
                            activeFilter === "Social" ? "bg-[#87CEEB] bg-opacity-10 text-[#87CEEB]" : "hover:bg-gray-50 text-gray-700"
                          }`}
                        ...
                        <button
                          className={`w-full text-left px-3 py-2 rounded-md flex items-center justify-between ${
                            activeFilter === "Art" ? "bg-[#87CEEB] bg-opacity-10 text-[#87CEEB]" : "hover:bg-gray-50 text-gray-700"
                          }`}
                        ...
                        <button
                          className={`w-full text-left px-3 py-2 rounded-md flex items-center justify-between ${
                            activeFilter === "Music" ? "bg-[#87CEEB] bg-opacity-10 text-[#87CEEB]" : "hover:bg-gray-50 text-gray-700"
                          }`}
                        ...
                        <button
                          className={`w-full text-left px-3 py-2 rounded-md flex items-center justify-between ${
                            activeFilter === "Math" ? "bg-[#87CEEB] bg-opacity-10 text-[#87CEEB]" : "hover:bg-gray-50 text-gray-700"
                          }`}
                  ...
                  {difficultyDropdownOpen && (
                    <div className="absolute right-0 mt-2 w-48 glass-card rounded-md shadow-lg z-10 border border-white/20" style={{ borderRadius: '6px' }}>
                      <div className="p-2">
                        <button
                          className={`w-full text-left px-3 py-2 rounded-md flex items-center justify-between ${
                            difficultyFilter === null ? "bg-[#87CEEB] bg-opacity-10 text-[#87CEEB]" : "hover:bg-gray-50 text-gray-700"
                          }`}
                        ...
                        <button
                          className={`w-full text-left px-3 py-2 rounded-md flex items-center justify-between ${
                            difficultyFilter === "Easy" ? "bg-[#87CEEB] bg-opacity-10 text-[#87CEEB]" : "hover:bg-gray-50 text-gray-700"
                          }`}
                        ...
                        <button
                          className={`w-full text-left px-3 py-2 rounded-md flex items-center justify-between ${
                            difficultyFilter === "Medium" ? "bg-[#87CEEB] bg-opacity-10 text-[#87CEEB]" : "hover:bg-gray-50 text-gray-700"
                          }`}
                        ...
                        <button
                          className={`w-full text-left px-3 py-2 rounded-md flex items-center justify-between ${
                            difficultyFilter === "Hard" ? "bg-[#87CEEB] bg-opacity-10 text-[#87CEEB]" : "hover:bg-gray-50 text-gray-700"
                          }`}
              ...
              {filteredActivities.map((activity) => (
                <Link href={`/activities/${activity.id}`} key={activity.id}>
                  <div className="glass-card rounded-xl overflow-hidden hover-lift transition-smooth">
                      ...
                      <div className="absolute top-4 right-4 flex gap-2">
                        <div
                          className={`${getCategoryColor(
                            activity.category,
                          )} text-white px-3 py-1 rounded-full text-xs font-medium border-0`}
                        >
                          {activity.category}
                        </div>
                        <div
                    ...
                    <div className="p-5">
                      <h3 className="text-lg font-semibold text-black mb-2">{activity.title}</h3>
