        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            <button
              ...
              className="flex items-center text-[#707eae] hover:text-[#87CEEB] mb-4"
            >
            ...
            <div className="flex justify-between items-center">
              ...
              <div
                className={`${getCategoryColor(activity.category)} text-white px-4 py-2 rounded-full text-sm font-medium border-0`}
              >
                {activity.category}
              </div>
            </div>
            ...
            <div className="md:col-span-2 glass-card rounded-xl overflow-hidden">
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <button className="text-[#707eae] hover:text-[#87CEEB]">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  <div>
                    ...
                    <div
                      className={`${getDifficultyColor(activity.difficulty)} px-2 py-0.5 rounded-full text-xs font-medium flex items-center justify-center`}
                    >
                      {activity.difficulty}
                    </div>
                  </div>
          ...
          <div className="glass-card rounded-xl p-6 mb-8">
            <div className="flex justify-between items-center mb-6">
              ...
              <button className="flex items-center text-[#707eae] hover:text-[#87CEEB]">
              ...
              {activity.participants.map((participant) => {
                ...
                return (
                  ...
                  >
                    ...
                    {participant.notes && (
                      <div className="mt-2 text-sm text-[#707eae] bg-white bg-opacity-50 p-3 rounded-xl">
